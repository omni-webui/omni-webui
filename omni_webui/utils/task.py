...
from omni_webui.config import DEFAULT_RAG_TEMPLATE
from omni_webui.utils.misc import get_last_user_message, get_messages_content
...
def prompt_template(
    template: str, user_name: str | None = None, user_location: str | None = None
) -> str:
...
def replace_messages_variable(template: str, messages: list[str] | None = None) -> str:
    def replacement_function(match):
...
def title_generation_template(
    template: str, messages: list[dict], user: dict | None = None
) -> str:
