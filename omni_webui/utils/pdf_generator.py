...
from omni_webui.env import FONTS_DIR, STATIC_DIR
...
class PDFGenerator:
    ...
    def __init__(self, title: str, messages: list[dict[str, Any]]):
        self.html_body = None
    ...
    def generate_chat_pdf(self) -> bytes:
        ...
        messages_html_list: List[str] = [
            self._build_html_message(msg) for msg in self.messages
        ]
