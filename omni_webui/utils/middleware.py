...
from omni_webui.config import DEFAULT_TOOLS_FUNCTION_CALLING_PROMPT_TEMPLATE
from omni_webui.constants import TASKS
from omni_webui.env import ENABLE_REALTIME_CHAT_SAVE, Environments
from omni_webui.models.chats import Chats
from omni_webui.models.users import UserModel, Users
from omni_webui.retrieval.utils import get_sources_from_files
from omni_webui.routers.retrieval import SearchForm, process_web_search
from omni_webui.routers.tasks import (
    generate_chat_tags,
    generate_queries,
    generate_title,
)
...
from omni_webui.tasks import create_task
from omni_webui.utils.chat import generate_chat_completion
...
from omni_webui.utils.task import (
    get_task_model_id,
    rag_template,
    tools_function_calling_generation_template,
)
from omni_webui.utils.tools import get_tools
...
async def chat_completion_tools_handler(
    ...
    try:
        response = await generate_chat_completion(
            request, env=env, form_data=payload, user=user
        )
