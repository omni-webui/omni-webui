...
from omni_webui.models.tools import Tools
...
def replace_imports(content):
    ...
    """
    replacements = {
        "from utils": "from omni_webui.utils",
        "from apps": "from omni_webui.apps",
        "from main": "from omni_webui.main",
        "from config": "from omni_webui.config",
    }
...
def load_tools_module_by_id(toolkit_id, content=None):
    ...
    try:
        ...
        logger.error(f"Error loading module: {toolkit_id}: {e}")
...
def install_frontmatter_requirements(requirements):
    if requirements:
        ...
        logger.info("No requirements found in frontmatter.")
