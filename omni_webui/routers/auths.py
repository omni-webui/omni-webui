...
from omni_webui.models.auths import (
    AddUserForm,
    ApiKey,
    Auths,
    LdapForm,
...
from omni_webui.utils.access_control import get_permissions
...
async def update_profile(
    ...
    if session_user:
        ...
        if user:
            ...
            raise OmniWebUIError("Failed to update user profile")
    else:
...
async def ldap_auth(request: Request, response: Response, form_data: LdapForm):
    ...
    try:
        ...
        logger.error(f"An error occurred on TLS: {str(e)}")
