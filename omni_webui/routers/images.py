...
from omni_webui.env import ENABLE_FORWARD_USER_INFO_HEADERS
from omni_webui.utils.auth import get_admin_user, get_verified_user
from omni_webui.utils.images.comfyui import (
...
class ImageConfigForm(BaseModel):
    MODEL: str
    IMAGE_SIZE: Annotated[str, Field(pattern=r"^\d+x\d+$")]
    IMAGE_STEPS: Annotated[int, Field(ge=0)]
