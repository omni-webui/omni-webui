...
from omni_webui._exc import FileTooLargeError, OmniWebUIError
...
def compress_audio(file_path: str):
    if os.path.getsize(file_path) > MAX_FILE_SIZE:
        ...
        if (
            ...
            raise FileTooLargeError(size=f"{MAX_FILE_SIZE_MB}MB")
