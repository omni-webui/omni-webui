...
from omni_webui.config import QDRANT_API_KEY, QDRANT_URI
from omni_webui.retrieval.vector.main import GetResult, SearchResult, VectorItem
...
class QdrantClient:
    ...
    def _create_collection(self, collection_name: str, dimension: int):
        ...
        logger.info(f"collection {collection_name_with_prefix} successfully created!")
